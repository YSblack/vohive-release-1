...
# VoHive 一键安装脚本
# 从本仓库下载预编译二进制并注册系统服务
# 用法: wget -O - https://raw.githubusercontent.com/mrlimuzi/vohive-release/master/install.sh | sh

REPO="mrlimuzi/vohive-release"
...
install_mcc_mnc_table() {
  ...
  mcc_mnc_url="https://github.com/${REPO}/releases/download/${VERSION}/mcc-mnc-table.json"
